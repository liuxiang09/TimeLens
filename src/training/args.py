...
class ModelArguments:
    ...
    model_id: Optional[str] = field(default="qwen3-vl")
...
class GRPOArguments(GRPOConfigTRL):
    ...
    reward_funcs: str = field(default="tiou")
...
class DataArguments:
    ...
    bench_root: Optional[str] = field(default=None)
