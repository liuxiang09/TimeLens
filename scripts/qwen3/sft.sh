...
min_tokens=64
total_tokens=3584 # 14336 or 3584
fps=2
fps_max_frames=""
seed=42

global_batch_size=1 # default 128
batch_per_device=1
num_devices=1 # default 8
epochs=1
target_size=90 # default 30000
deepspeed_config="scripts/zero3_offload.json"
output_root="output/temporal_grounding/qwen3/sft"
report_to="none"
...
deepspeed --module src.timelens.train.sft \
  --bf16 True \
  --fp16 False \
