...
output_root="output/temporal_grounding/qwen25/grpo"
report_to="none"
...
if [[ -z "${raw_anno_path}" ]]; then echo "--raw_anno_path is required."; exit 1; fi
...
deepspeed --module src.timelens.train.grpo \
  --bf16 True \
  --fp16 False \
